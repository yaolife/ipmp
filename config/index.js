...
// 业务后端地址，联调时只改这一处
const BACKEND_API_TARGET = "http://192.168.0.254:8000";//YJ-WIFI外网后端
//const BACKEND_API_TARGET = "http://192.168.29.254:8000";//个人热点
//const BACKEND_API_TARGET = "http://localhost:8000";//本地后端
module.exports = {
    dev: {
