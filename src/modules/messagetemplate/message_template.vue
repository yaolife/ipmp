      ...
      <div class="cud__scroll--div">
          ...
          <div class="cud__tree--right">
            ...
            >
              <TableWithToolbar
                ...
                :total="total"
                :queryTableId="'message_template_table'"
                isCheckBox
              ...
              >
                ...
                <template #toolbar-buttons>
                  <el-button
                    ...
                    v-if="btnShow('message_template_add')"
                    >{{ $t("tm.add") }}</el-button
                  >
                  <el-button
                    ...
                    v-if="btnShow('message_template_delete')"
                ...
                <template #operation="{ row }">
                  <el-button
                    ...
                    v-if="btnShow('message_template_edit')"
                  ...
                  >
                    ...
                    <el-dropdown-menu slot="dropdown" :append-to-body="!isFullscreen">
                      <el-dropdown-item
                      ...
                      <el-dropdown-item
                        :command="
                          beforeMoreCommandHandler('exportMessageTemplate', row)
                        "
                      >
                        <span
                          style="
        ...
        >
          <div class="cud__mlr-20 cud__mtb-20">
            <b>{{ $t("tm.number") }}：</b>{{ objeDataToDetails.templateCode }}
          </div>
          <div
            class="cud__mlr-20 cud__mtb-20"
            v-html="objeDataToDetails.templateContent"
          ></div>
        </el-dialog>
        <div>
          <el-dialog
          ...
          >
            <query-form
              :queryFormId="'message_template_2'"
...
<script>
import message_template from "./js/message_template";
