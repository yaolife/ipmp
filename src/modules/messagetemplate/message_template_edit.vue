          ...
          >
            <el-card class="box-card-20">
              ...
              <el-row>
                ...
                <el-col :span="24" class="cud__mtb-10" style="margin:0">
                  <el-form-item :label="$t('tm.templateContent')">
                    <!--                    <tinymce-editor ref="editor" v-model="editorContent" :value="editorContent" :menubarFlg="false" :plugins="plugins" :toolbar="toolbar"  :disabled="disabled"></tinymce-editor>-->
                    <el-input
            ...
            <div class="cud-examine-tool">
              ...
              >
                ...
                <el-button
                  size="small"
                  type="primary"
                  @click="updateMessageTemplate('ruleForm')"
                  >{{ $t("cm.save") }}</el-button
                >
...
<script>
import message_template_edit from "./js/message_template_edit";
export default message_template_edit;
</script>

<style lang="less" scoped>
/deep/ .el-card.is-always-shadow {
  margin: 15px 22px 60px 0px;
}
