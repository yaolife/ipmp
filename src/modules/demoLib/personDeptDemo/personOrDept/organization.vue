      ...
      <el-row class="keywordBar">
          ...
          <el-card class="box-card left_tree" shadow="never">
            ...
            <div slot="header" class="clearfix">
              ...
              <div class="header-btn">
                <el-button type="text" @click="selectAll">选择全部</el-button>
                <el-button type="text" @click="selectNone">取消全部</el-button>
              </div>
            </div>
            <el-row>
        ...
        <el-col :span="2">
          <el-row style="margin-top: 140px">
            <el-row style="text-align: center">
              <el-button
                style="margin: 10px auto; position: relative; overflow: hidden"
                type="primary"
                size="small"
              ...
              <el-button type="primary" size="small" @click="checkedNodesToLeft"
        ...
        <el-col :span="11">
          ...
          <el-card class="box-card left_tree" shadow="never">
            ...
            <el-row>
              <el-row class="left_tree_body" v-if="reLoadR">
                <el-scrollbar style="height: 100%">
                  <transition name="el-zoom-in-center">
                    <el-row>
                      <!-- <el-input
